...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        Astronaut as =new Human();
        //Astronaut as =new Human() если так попытатся вызвать метод гетАге который есть только в хумане то будет ошибка
        // тк в классе родители такого метода нету. чтобы исключить ошибку надо привести тип  Human as2 =(Human) as

       Human as2 =(Human)as;
        System.out.println(as2.getAge()); //теперь работает
