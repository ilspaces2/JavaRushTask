...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ZonedDateTime localDateTime =ZonedDateTime.of(fromDateTime,fromZone);
        ZonedDateTime localDateTime2 =ZonedDateTime.of(localDateTime.toLocalDate(),localDateTime.toLocalTime(),toZone);
        System.out.println(localDateTime);
        System.out.println(localDateTime2);
        return         localDateTime2.toLocalDateTime();
