...
public class Solution {
    ...
    public static String getTranslationForDayOfWeek(String ru) {
        ...
        else if (ru.equals("вторник")) en = "Tuesday";
        else if (ru.equals("среда")) en = "Wednesday";
        else if (ru.equals("четверг")) en = "Thursday";
        else if (ru.equals("пятница")) en = "Friday";
        else if (ru.equals("суббота")) en = "Saturday";
        else if (ru.equals("воскресенье")) en = "Sunday";
