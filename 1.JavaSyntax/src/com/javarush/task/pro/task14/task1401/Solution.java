...
public class Solution {
    ...
    static void addUser(User user) {
        ...
        if (user.setName(name) == -1) System.out.printf(CANNOT_BE_NULL);
        else if (user.setName(name) == -2) System.out.printf(CANNOT_BE_EMPTY);
        else if (user.setName(name) == -3) System.out.printf(CANNOT_CONTAIN_DIGIT);
        else if (user.setName(name) != 0) System.out.printf(UNKNOWN_ERROR);
        else user.setName(name);
        user.setAge(age);
        if (user.setAge(age) == -1) System.out.printf(CANNOT_BE_NEGATIVE);
        else if (user.setAge(age) == -2) System.out.printf(CANNOT_BE_TOO_BIG);
        else if (user.setAge(age) != 0) System.out.printf(UNKNOWN_ERROR);
